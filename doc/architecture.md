...
| Conduct | Combat body-state override per action application (`csbs_flags.body_state`) | (subscribes to `npc_on_combat_set_body_state`); `xcombat.get_crouch_openness` |
